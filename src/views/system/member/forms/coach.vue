    ...
    <div class="member-form-content">
      <el-form ref="form" :model="form" label-width="120px" size="mini">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item
              prop="partTimeCompany"
              label="兼职工作单位"
            >
              <el-input v-model="form.partTimeCompany" placeholder="请填写兼职工作单位" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item
              ...
              label="现工作单位地址"
              :rules="[
                { required: true, message: '请选择现工作单位地址', trigger: 'blur' }
              ]"
            >
              <el-select
              ...
              <el-select v-model="form.companyCounty" filterable placeholder="现工作单位区/县">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="现工作单位详细地址"
              :rules="[
                { required: true, message: '请填写现工作单位详细地址', trigger: 'blur' }
              ]"
            >
              <el-input v-model="form.companyAddress" placeholder="请输入现工作单位详细地址" />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="10">
            ...
            >
              <el-input v-model="form.school" placeholder="请填写毕业院校" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            ...
            >
              <el-select v-model="form.record" filterable placeholder="请选择最高学历">
                <el-option
        ...
        >
          ...
          >
            <el-form ref="tab" :model="tab" label-width="120px" :disabled="action === 'examine'">
              <el-row :gutter="20">
                ...
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="教练等级"
                    :rules="[
                      { required: true, message: '请选择教练等级', trigger: 'blur' }
                    ]"
                  >
                    <el-select v-model="tab.level" placeholder="请选择教练等级">
                      <el-option
                        v-for="(item, index) in coachLevel"
                        :key="index"
                        :label="item"
                        :value="item"
                      />
              ...
              <el-row :gutter="20">
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="教练员资格证编号"
                    :rules="[
                      { required: true, message: '请填写教练员资格证编号', trigger: 'blur' }
                    ]"
                  >
                    <el-input v-model="tab.certifiedNumber" placeholder="请填写教练员资格证编号" />
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="教练证上传"
                    :rules="[{ required: true, message: '请上传教练证', trigger: 'blur' }]"
                  >
              ...
              <div
                v-for="(workExp, workExpIndex) in tab.coachExps"
                      ...
                      <el-row :gutter="20">
                        <el-col :span="10">
                          <el-form-item
                            ...
                            label="执教开始时间"
                            :rules="[
                              { required: true, message: '请选择执教开始时间', trigger: 'blur' }
                            ]"
                          >
                            <el-date-picker
                      ...
                      <el-row :gutter="20">
                        <el-col :span="10">
                          <el-form-item
                            ...
                            label="经历及主要成绩"
                            :rules="[
                              { required: true, message: '请填写经历及主要成绩', trigger: 'blur' }
                            ]"
                          >
                            <el-input
...
export default {
  ...
  methods: {
    ...
    selectProvince2(value) {
      delete this.form.companyCity
      delete this.form.companyCounty
      this.cityOptions2 = []
      this.countyOptions2 = []
      let targetCode = ''
    ...
    removeWorkExpAther(workExpIndex) {
      const projectIndex = this.projectTabIndex
      const projectItem = this.form.projects[projectIndex]
      projectItem.coachExps.splice(workExpIndex, 1)
      this.form.projects.splice(projectIndex, 1, { ...projectItem })
    },
    formValidate(form) {
