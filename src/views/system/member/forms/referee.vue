  ...
  <div class="member-form">
    <div class="member-form-content">
      <el-form ref="form" :model="form" label-width="120px" size="mini">
          ...
          <el-col :span="10">
            ...
            >
              <el-select v-model="form.identity" placeholder="请选择身份">
                ...
                <el-option label="非在校学生" value="非在校学生" />
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item
              ...
              label="外语水平"
            >
              <el-input v-model="form.foreignLevel" placeholder="请输入外语水平" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="所属专业"
            >
              <el-input v-model="form.major" placeholder="请填写所属专业" />
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="现工作单位"
            >
              <el-input v-model="form.company" placeholder="请填写现工作单位" />
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item
        ...
        <h3>项目列表</h3>
        <el-tabs v-model="projectTabIndex" type="card" editable @edit="handleProjectTabsEdit">
          <el-tab-pane
            v-for="(tab, pindex) in form.projects"
            :key="pindex"
            :label="tab.name || `项目${pindex + 1}`"
            :name="`${pindex}`"
          >
            <el-form ref="tab" :model="tab" label-width="120px">
              <el-row :gutter="20">
                <el-col :span="10">
                  <el-form-item
                    prop="name"
              ...
              <el-row :gutter="20">
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="裁判等级"
                  >
                    <el-select v-model="tab.level" placeholder="请选择裁判等级">
                      <el-option
                        v-for="(item, index) in refereeLevels"
                        :key="index"
                        :label="item"
                        :value="item"
                      />
                ...
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="裁判岗位(多选)"
                  >
                    <el-select v-model="tab.workJobs" multiple placeholder="请选择裁判等级">
                      <el-option
                        v-for="(item, index) in refereeJobs"
                        :key="index"
                        :label="item"
                        :value="item"
                      />
              ...
              <el-row :gutter="20">
                <el-col :span="10">
                  <el-form-item prop="otherWorkJob" label="其他制裁岗位">
                    <el-input v-model="tab.otherWorkJob" placeholder="请填写现工作单位" />
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item
                    prop="refereeCertificateImage"
                    label="裁判员证"
                    :rules="[
                      { required: true, message: '请选上传裁判员证', trigger: 'blur' }
                    ]"
                  >
                    <Uploader v-model="tab.refereeCertificateImage" />
                  </el-form-item>
                </el-col>
              </el-row>
              <div class="second-form-legend">
                <span class="title">工作履历</span>
                <el-button icon="el-icon-plus" circle size="small" @click="addWorkExp" />
              </div>
              <div
                v-for="(workExp, workExpIndex) in tab.workExps"
                :key="workExpIndex"
                class="workexp-line"
              >
                <el-form ref="tab" :model="workExp" label-width="120px">
                  <el-row :gutter="10">
                    <el-col :span="7">
                      <el-form-item
                        prop="gameDate"
                    ...
                    <el-col :span="7">
                      ...
                      >
                        <el-input v-model="workExp.gameTitle" placeholder="请输入比赛名称" />
                      </el-form-item>
                    </el-col>
                    <el-col :span="7">
                      <el-form-item
                        ...
                        label="执裁位置"
                        :rules="[
                          { required: true, message: '请输入执裁位置', trigger: 'blur' }
                        ]"
                      >
                        <el-input v-model="workExp.workPosition" placeholder="请输入执裁位置" />
                      </el-form-item>
                    </el-col>
                    <el-col :span="1">
                      <el-button
...
export default {
  ...
  methods: {
    ...
    handleProjectTabsEdit(targetName, action) {
      if (action === 'add') {
        this.form.projects.push({ workExps: [], workExpTabIndex: 0 })
      }
      if (action === 'remove') {
