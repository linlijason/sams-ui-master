        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="装备单位名称"
              :rules="[
                { required: true, message: '请输入装备单位名称', trigger: 'blur' }
              ]"
            >
              <el-input v-model="form.name" placeholder="请输入装备单位名称" />
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="单位简介"
              :rules="[
                { message: '请输入单位简介', trigger: 'blur' }
              ]"
            >
              <el-input v-model="form.intro" placeholder="请输入单位简介" />
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item
              ...
              label="单位照片"
              :rules="[
                { required: true, message: '请上传单位照片', trigger: 'blur' }
              ]"
            >
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="商品照片"
              :rules="[
                { message: '请上传商品照片', trigger: 'blur' }
              ]"
            >
              <Uploader v-model="form.productPhotos" multiple />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleProjectTabsEdit(targetName, action) {
      ...
      if (action === 'remove') {
        this.form.equipmentCoaches.splice(targetName, 1)
      }
    },
    // 验证方法
    formValidate(form) {
    ...
    async submitForm(action, tag) {
      ...
      if (action === 'insert' || action === 'update') {
        ...
        // if (this.form.equipmentCoaches.length <= 0) {
        //   this.$message({
        //     message: '至少添加一项项目',
        //     type: 'error'
        //   })
