        ...
        >
          ...
          >
            <el-form ref="tab" :model="tab" label-width="120px" :disabled="action === 'examine'">
              <el-row :gutter="20">
                ...
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="运动员国家等级"
                    :rules="[
                      { required: true, message: '请选择运动员国家等级', trigger: 'blur' }
                    ]"
                  >
              ...
              <el-row :gutter="20">
                <el-col :span="10">
                  <el-form-item prop="club" label="所在俱乐部">
                    <el-input v-model="tab.club" placeholder="请填写所在俱乐部" />
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item prop="exerciseVenues" label="常锻炼场馆">
                    <el-input v-model="tab.exerciseVenues" placeholder="请填写常锻炼场馆" />
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
