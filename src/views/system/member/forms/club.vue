  ...
  <div class="member-form">
    <div class="member-form-content">
      <el-form ref="form" :model="form" label-width="120px" size="mini">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item
              ...
              label="学校/俱乐部名称"
              :rules="[
                { required: true, message: '请输入学校/俱乐部名称', trigger: 'blur' }
              ]"
            >
              <el-input v-model="form.name" placeholder="请输入学校/俱乐部名称" />
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item
        ...
        <el-row :gutter="20">
          <el-col v-for="(value,index) in form.trainingVenues" :key="index" :span="16">
            <el-form-item
              :prop="`trainingVenues[${index}]`"
              :label="`场馆${index + 1}`"
              :rules="[
                { message: '请输入场馆地址', trigger: 'blur' }
              ]"
            >
              <el-input
                v-model="form.trainingVenues[index]"
                placeholder="请输入场馆地址"
              ...
              <el-button
                v-if="index !== 0"
                type="danger"
                @click="form.trainingVenues.splice(index, 1)"
              >删除</el-button>
            </el-form-item>
          </el-col>
          <el-col :span="10" :offset="2">
            <el-button type="primary" @click="form.trainingVenues.push('')">添加场馆</el-button>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item
              ...
              label="学校/俱乐部照片"
              :rules="[
                { required: true, message: '请上传学校/俱乐部照片', trigger: 'blur' }
              ]"
            >
        ...
        >
          <el-tab-pane
            v-for="(tab, pindex) in form.clubCoaches"
            :key="pindex"
            ...
            <el-form ref="tab" :model="tab" label-width="120px" :disabled="action === 'examine'">
              <el-row :gutter="20">
                <el-col :span="10">
                  ...
                  >
                    <el-input v-model="tab.name" placeholder="请输入场馆地址" />
                  </el-form-item>
                </el-col>
                <el-col :span="10">
                  <el-form-item
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="10">
                  <el-form-item
                    ...
                    label="个人照片(2寸免冠照片)"
                    :rules="[
                      { message: '请上传个人照片', trigger: 'blur' }
                    ]"
                  >
                    <Uploader v-model="tab.photo" />
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
...
export default {
  ...
  methods: {
    ...
    handleProjectTabsEdit(targetName, action) {
      ...
      if (action === 'remove') {
        this.form.clubCoaches.splice(targetName, 1)
      }
    },
    // 验证方法
    formValidate(form) {
    ...
    async submitForm(action, tag) {
      ...
      if (action === 'insert' || action === 'update') {
        ...
        // if (this.form.clubCoaches.length <= 0) {
        // this.$message({
        // message: '至少添加一项教练员',
        // type: 'error'
        // })
